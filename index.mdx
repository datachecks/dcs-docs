...
|-----------|-------------|
| **Bifrost** | The web UI where you connect data sources, run agents, review results, and manage your workspace |
| **Stormbreaker** | The backend API that powers all operations — comparisons, validations, jobs, and integrations |
| **Krypto** | The AI agent module that runs the four agents using LangGraph-based workflows |
