...
<RequestExample>
```bash cURL
curl -X POST "https://api.datachecks.io/comparisons/eeeeeeee-0000-0000-0000-000000000005/execute" \
...
url = f"https://api.datachecks.io/comparisons/{comparison_id}/execute"
headers = {
...
const response = await fetch(
  `https://api.datachecks.io/comparisons/${comparisonId}/execute`,
  {
    method: "POST",
    headers: {
      "Authorization": "Bearer <api-key>",
