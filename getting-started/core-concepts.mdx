...
An API key authenticates programmatic access to the Stormbreaker API. You can create and manage API keys under Settings. API keys are scoped to a workspace.
